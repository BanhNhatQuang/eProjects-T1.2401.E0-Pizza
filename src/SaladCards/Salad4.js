...
function Salad4(props) {
    return (
        <div className='container1' id='sencond'>
            <div className='card2'>
                <img className='pic' id='MyY' src='http://thepizzacompany.vn/images/thumbs/000/0002601_crispy-salmon-skin-salad_300.png'></img>
                <h3 id='cuoi'>Salad Da Cá Hồi Giòn</h3>
                <div className='des' id='cuoi'>Salad với da cá hồi giòn với bắp cải đỏ, cà chua bi, ngô với sốt Yuzu</div>
