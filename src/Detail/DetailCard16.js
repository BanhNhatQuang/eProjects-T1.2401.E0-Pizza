        ...
        <div>
            ...
            <div className='DetailBox'>
                <div className='DetailBox1'>
                    <img className='DetailPic' src='http://thepizzacompany.vn/images/thumbs/000/0002224_hawaii_300.png'></img>
                    <h2 className='DetailPrice'>139.000đ</h2>
                </div>
                <div className='DetailBox2'>
                    <div className='Box2'>
                        <div className='price'>___</div>
                        <h2>Pizza Hawaiian</h2>
                        <div className='kich-thuoc'>Kích thước Nhỏ 6” - Đế Dày</div>
                        <div>Giăm bông, thịt muối và dứa</div>
                        {/* <br></br> */}
