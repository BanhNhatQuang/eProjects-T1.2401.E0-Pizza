        ...
        <div>
            ...
            <div className='DetailBox'>
                <div className='DetailBox1'>
                    <img className='DetailPic' src='http://thepizzacompany.vn/images/thumbs/000/0002212_sf-cocktail-test_300.png'></img>
                    <h2 className='DetailPrice'>159.000đ</h2>
                </div>
                <div className='DetailBox2'>
                    <div className='Box2'>
                        <div className='price'>___</div>
                        <h2>Seafood and Cocktail Pizza</h2>
                        <div className='kich-thuoc'>Small size 6" with thick base</div>    

                        <div>Shrimp, crab, ham,... with Thousand Island sauce</div>
                        {/* <br></br>/ */}
