        ...
        <div>
            ...
            <div className='DetailBox'>
                <div className='DetailBox1'>
                    <img className='DetailPic' src='http://thepizzacompany.vn/images/thumbs/000/0002222_ca-bacon_300.png'></img>
                    <h2 className='DetailPrice'>149.000đ</h2>
                </div>
                <div className='DetailBox2'>
                    <div className='Box2'>
                        <div className='price'>___</div>
                        <h2>Pizza Thịt Nguội Kiểu Canada</h2>
                        <div className='kich-thuoc'>Kích thước Nhỏ 6” - Đế Dày</div>
                        <div>Sự kết hợp giữa thịt nguội và bắp ngọt</div>
                        <br></br>
