        ...
        <div>
            ...
            <div className='DetailBox'>
                <div className='DetailBox1'>
                    <img className='DetailPic' src='http://thepizzacompany.vn/images/thumbs/000/0002218_sup-deluxe_300.png'></img>
                    <h2 className='DetailPrice'>149.000đ</h2>
                </div>
                <div className='DetailBox2'>
                    <div className='Box2'>
                        <div className='price'>___</div>
                        <h2>Five Meat Feast And Vegetables
                            Special Pizza</h2>
                        <div className='kich-thuoc'>Small size 6" with thick base</div>

                        <div>Beef sausage, ham, bacon,... and a whole world of vegetables</div>
                        {/* <br></br> */}
