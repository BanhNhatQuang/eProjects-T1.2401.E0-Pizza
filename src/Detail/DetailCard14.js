        ...
        <div>
            ...
            <div className='DetailBox'>
                <div className='DetailBox1'>
                    <img className='DetailPic' src='http://thepizzacompany.vn/images/thumbs/000/0002225_double-pepperoni_300.png'></img>
                    <h2 className='DetailPrice'>139.000đ</h2>
                </div>
                <div className='DetailBox2'>
                    <div className='Box2'>
                        <div className='price'>___</div>
                        <h2>Italian Sausage Pizza</h2>
                        <div className='kich-thuoc'>Small size 6" with thick base</div>    

                        <div>Spicy Italian sausage on tomato sauce</div>
                        {/* <br></br> */}
